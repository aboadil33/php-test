...
<body text="#000000">
    ...
    <p align="center">
        <font size="5" face="Bauhaus 93">MAILER INBOX SENDING</font>
        <font color="#FFFFFF" size="5" face="Bauhaus 93">RFX</font>
    </p>
        ...
        <table width="100%" border="0" height="407">
            ...
            <tr>
                ...
                <td height="22" bgcolor="#E8E8E8" rowspan="2">
                    ...
                    <div align="right">
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="-3">SMTP CONFIG:</font>
                    </div>
                </td>

                <td height="22" bgcolor="#E8E8E8" rowspan="2">

                    <textarea type="text" id="my_smtp" name="my_smtp" cols="45" rows="3" style="float:left;"><?php echo $my_smtp; ?></textarea>
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><SPAN style="display:block;float:left;">&nbsp;&nbsp;Every&nbsp;&nbsp;</span><input name="nrotat" type="text" style="width:50px;float:left;" value="<?php echo $nrotat; ?>">&nbsp;&nbsp;EMAIL'S

                    </font><br><br><br><input type="button" name="reset" id="reset" value="reset">
                </td>
            ...
            <tr>
                ...
                <td class="td1" height="22" bgcolor="#E8E8E8">
                    ...
                    <div align="right">
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="-3">Port :</font>
                    </div>
                ...
                <td height="22" bgcolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
                        ...
                        <input type="text" name="ssl_port" id="ssl_port" value="<?php echo $ssl_port; ?>" size="5"> <input type="button" name="add" id="add" value="add smtp">
                    </font>
                </td>
                ...
                <td height="22" bgcolor="#E8E8E8">
                    ...
                    <div align="right">
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="-3">SEND PAUSE:</font>
                    </div>

                </td>
                <td width="41%" height="22" bgcolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
            ...
            <tr>
                ...
                <td class="td1" height="22" bgcolor="#E8E8E8">
                    ...
                    <p align="right">
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="-3">SSL Server:</font>
                </td>

                <td height="22" bgcolor="#E8E8E8">
                    <input type="radio" name="SSLTLS" value="SSL">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(SSL)</font>
                    <input type="radio" name="SSLTLS" value="TLS">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(TLS)</font>
                    <input type="radio" name="SSLTLS" value="NON">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(NON)</font>
                </td>
            ...
            <tr>
                ...
                <td height="22" bgcolor="#E8E8E8">
                    <input type="checkbox" name="isbcc" value="true" <?php if ($isbcc == "true") echo "checked"; ?>>
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(yes)</font>
                </td>

                <td height="22" bgcolor="#E8E8E8">

                    <p align="right">
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="-3">NUM OF EMAIL IN BCC :</font>
                </td>
                ...
                <td width="100%" height="39" bgcolor="#E8E8E8" colspan="4">
                    ...
                    <p align="center">
                        <font face="Arial" style="font-size: 9pt" color="#800000"><b>&quot;</b> IF
                            YOU DON'T HAVE SMTP LOGIN INFORMATION'S, LEAVE BLANK TO SEND WITH LOCALHOST <b>&quot;</b></font>
                </td>
            ...
            <tr>
                ...
                <td width="100%" colspan="4" bgcolor="#666666" height="36">
                    ...
                    <b>
                        ...
                        <font face="Arial" size="2" color="#FFFFFF">&nbsp;MESSAGE SETUP</font>
                    </b>
                </td>
            ...
            <tr>
                ...
                <td height="22" bordercolor="#E8E8E8" bgcolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
                ...
                <td width="41%" height="22" bordercolor="#E8E8E8" bgcolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
            ...
            <tr>
                ...
                <td height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
                ...
                <td width="41%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">

                        &nbsp;</font><select name="epriority" id="listMethod" onchange="showHideListConfig()">
                        <option value="" <?php if (strlen($epriority) < 1) {
                                                print "selected";
                                            } ?>>
                            NO PRIORITY</option>
                        <option value="1" <?php if ($epriority == "1") {
                                                print "selected";
                                            } ?>>HIGH</option>
                        <option value="3" <?php if ($epriority == "3") {
                                                print "selected";
                                            } ?>>NORMAL</option>
                        <option value="5" <?php if ($epriority == "5") {
                                                print "selected";
                                            } ?>>LOW</option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td width="41%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
                        ...
                        <option value="no" <?php if ($encodety == "no") {
                                                print "selected";
                                            } ?>>NO</option>
                        <option value="8bit" <?php if ($encodety == "8bit") {
                                                    print "selected";
                                                } ?>>8bit</option>
                        <option value="7bit" <?php if ($encodety == "7bit") {
                                                    print "selected";
                                                } ?>>7bit</option>
                        <option value="binary" <?php if ($encodety == "binary") {
                                                    print "selected";
                                                } ?>>binary</option>
                        <option value="base64" <?php if ($encodety == "base64") {
                                                    print "selected";
                                                } ?>>base64</option>
                        <option value="quoted-printable" <?php if ($encodety == "quoted-printable") {
                                                                print "selected";
                        ...
                        <option value="x-mac-chinesesimp">Chine*******-mac-chinesesimp</option>
                        <option value="cp-936">Chinese -> cp-936</option>
                        <option value="big5">Chinese -> big5</option>
                        <option value="x-mac-chinesetrad">Chine*******-mac-chinesetrad</option>
            ...
            <tr>
                ...
                <td width="35%" colspan="" height="22" bordercolor="#E8E8E8" bgcolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
                ...
                <td width="41%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8">
                    </font><input name="userfile" type="file"></td>
            </tr>

            <tr valign="top">

                <td colspan="3" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8">
                ...
                <td width="41%" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8">
                    <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
...
class SMTP
{
     ...
     * @param integer|array ***pect One or more expected integer success codes
     * @access protected
     * @return boolean True on success.
     */
    protected function sendCommand($command, $commandstring, ***pect)
    {
        if (!$this->connected()) {
...
class PHPMailer
{
    ...
    /**
     * Constructor.
     * @param boolean ***ceptions Should we throw external exceptions?
     */
    public function __construct(***ceptions = null)
    {
        if (***ceptions !== null) {
            $thi*****ceptions = (bool)***ceptions;
        }
    }
    /**
     * Destructor.
    ...
    protected function addOrEnqueueAnAddress($kind, $address, $name)
    {
        ...
        if ($this->has8*****ars(substr($address, ++$pos)) and $this->idnSupported()) {
            if ($kind != 'Reply-To') {
    ...
    public function setFrom($address, $name = '', $auto = true)
    {
        ...
        if (($pos = strrpos($address, '@')) === false or
            (!$this->has8*****ars(substr($address, ++$pos)) or !$this->idnSupported()) and
     ...
     * bu****** also the message ID of the last sent message except in
     * pathological cases.
     * @return string
     */
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        if (!$patternselect or $patternselect == 'auto') {
            ...
            if (defined('PCRE_VERSION')) {
                ...
                //Filter_va******ared in PHP 5.2.0 and does not require the PCRE extension
    ...
    public function punyencodeAddress($address)
    {
        ...
        if (
            ...
            if ($this->has8*****ars($domain) and @mb_check_encoding($domain, $this->CharSet)) {
    ...
    public function send()
    {
        ...
        } catch (phpmailerException ***c) {
            $this->mailHeader = '';
            $this->setError(***c->getMessage());
            if ($thi*****ceptions) {
                throw ***c;
            }
            return false;
    ...
    public function smtpConnect($options = null)
    {
        ...
        if ($thi*****ceptions and !is_null($lastexception)) {
            throw $lastexception;
        }
        return false;
    }
    ...
    public function createBody()
    {
        ...
        if ($bodyEncoding == '8bit' and !$this->has8*****ars($this->Body)) {
            $bodyEncoding = '7bit';
        ...
        //Can we do a 7-bit downgrade?
        if ($altBodyEncoding == '8bit' and !$this->has8*****ars($this->AltBody)) {
     ...
     * @access public
     * @param string $str multi-byte text to w*****ncode
     * @return boolean
     */
    ...
    /**
     * Does a string contain any 8-******ars (in any charset)?
     * @param string $text
     * @return boolean
     */
    public function has8*****ars($text)
    {
    ...
    /**
     * Backward compatibility w*****r for an old QP encoding function that was removed.
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ($key == 'smtp_connect_failed') {
                ...
                //bu****** usually not PHPMailer's fault.
     ...
     * @param string ***t File extension
     * @access public
     * @return string MIME type of file.
     * @static
     */
    public static function _mime_types(***t = '')
    {
        $mimes = array(
            ...
            'xlam'  => 'application/vnd.m****cel.addin.macroEnabled.12',
            'xlsb'  => 'application/vnd.m****cel.sheet.binary.macroEnabled.12',
        ...
        if (array_key_exists(strtolower(***t), $mimes)) {
            return $mimes[strtolower(***t)];
        }
     ...
     * @param string ***tracerts_filename Optional path to chain certificate
     */
    public function sign($cert_filename, $key_filename, $key_pass, ***tracerts_filename = '')
    {
        $this->sign_cert_file = $cert_filename;
        $this->sign_key_file = $key_filename;
        $this->sign_key_pass = $key_pass;
        $this->sign_extracerts_file = ***tracerts_filename;
    }
    /**
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $header******plode($this->LE, $headers_line);
        $from_header = '';
        $to_header = '';
        $date_header = '';
        $current = '';
 ...
 * @package PHPMailer
 */
class phpmailerException extend****ception
{
    /**
